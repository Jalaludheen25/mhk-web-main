...
const translations = {
    en: {
        ...
        "nav.grains": "Grains & Pulses",
        "nav.grainsDesc": "Rice, Pulses & Cereals",
        "nav.spices": "Spices & Seasonings",
        "nav.spicesDesc": "Herbs & Blends",
        "nav.processed": "Processed Foods",
        "nav.processedDesc": "Canned & Packaged",
        "nav.buildingMaterials": "Building Materials",
        "nav.buildingMaterialsDesc": "Construction Supplies",
    ...
    ar: {
        ...
        "nav.grains": "الحبوب والبقوليات",
        "nav.grainsDesc": "الأرز والبقوليات والحبوب",
        "nav.spices": "التوابل والمرق",
        "nav.spicesDesc": "الأعشاب والخلطات",
        "nav.processed": "الأطعمة المصنعة",
        "nav.processedDesc": "المعلبات والمغلفات",
        "nav.buildingMaterials": "مواد البناء",
        "nav.buildingMaterialsDesc": "مستلزمات البناء",
